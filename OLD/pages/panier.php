<section class="layout" id="page">
    ...
    <div class="content-headline">
            <h2>Panier</h2>
            <h3>Achetez plusieurs items en déboursant une seule fois</h3>
        </div>
        <?php
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
            	...
            	else
            	{
	            	for($i = 0; $i < $nbArticles; $i++)
	            	{
	            		...
	            		<tr>
		                    ...
		                    echo $precedent; ?> <i class="<?=$_Theme_['All']['Tokens']['icon'];?>"></i></td>
		        ...
		        <tr>
		        	<td>Total:</td>
		        	<td class="w-25 text-center" colspan="5"><?php echo number_format($_Panier_->montantGlobal(), 0, ',', ' '); ?> <i class="<?=$_Theme_['All']['Tokens']['icon'];?>"></i></td>
		        </tr>
            </tbody>
        </table>
        ...
        <div class="text-right">
            <a href="?action=viderPanier"><button class="btn btn-lg btn-danger">Vider le panier</button></a>
            <a href="?action=achat"><button class="btn btn-lg btn-success">Acheter</button></a>
        </div>
    </div>
</section>