        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <?php if(!empty($_Theme_['Pied']['facebook'])){ ?>
                    <li><a href="<?php echo $_Theme_['Pied']['facebook'] ?>" target="_blank"><i class="fa fa-facebook"></i></a></li>
                <?php }
                if (!empty($_Theme_['Pied']['youtube'])){?>
                    <li><a href="<?php echo $_Theme_['Pied']['twitter'] ?>" target="_blank"><i class="fa fa-twitter"></i></a></li>
                <?php }
                if (!empty($_Theme_['Pied']['youtube'])){ ?>
                    <li><a href="<?php echo $_Theme_['Pied']['youtube']  ?>" target="_blank"><i class="fa fa-youtube-play"></i></a></li>
                <?php }
